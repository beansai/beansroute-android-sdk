...
class BeansStopMarkerApartmentImpl: RelativeLayout {
    ...
    init {
        val v = LayoutInflater.from(context)
            .inflate(R.layout.beans_stop_marker_apartment, this, true) as RelativeLayout

        containerSmall = v.findViewById(R.id.apt_container_small)
        ...
        containerLarge = v.findViewById(R.id.apt_container_large)
