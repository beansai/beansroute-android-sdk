...
class BeansStopMarkerDropoffImpl: RelativeLayout {
    ...
    init {
        val v = LayoutInflater.from(context)
            .inflate(R.layout.beans_stop_marker_dropoff, this, true) as RelativeLayout

        containerSmall = v.findViewById(R.id.dropoff_container_small)
        ...
        containerLarge = v.findViewById(R.id.dropoff_container_large)
